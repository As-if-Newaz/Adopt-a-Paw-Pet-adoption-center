...
namespace BLL.Services
{
    public class UserService
    {
        ...
        {   obj.RegDate = DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Utc);
            obj.AuthKey = Guid.NewGuid().ToString();
            obj.AuthKey = obj.AuthKey.Substring(0, 15);
            obj.Active = false;
            obj.Role = "User";
            obj.IsDeleted = false;
        ...
        {
            return DataAccess.RegValData().Validate(authkey);
